...
[![Build Status](https://github.com/profiprog/reverse_heders/workflows/Main/badge.svg?branch=master)](https://github.com/profiprog/reverse_heders/actions)
...
experimental:
  plugins:
    example:
      moduleName: github.com/profiprog/reverse_heders
      version: v0.2.1
```
...
(In the above example, the `plugindemo` plugin will be loaded from the path `./plugins-local/src/github.com/profiprog/reverse_heders`.)
